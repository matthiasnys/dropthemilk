...
function App() {
  ...
  return (
    <div className="w-full h-full relative bg-black">
      ...
      {isActive && showControls && !showTextInput && (
        <div className="absolute top-4 right-4 z-20">
          <div className="bg-black/70 backdrop-blur-sm rounded-lg p-4 border border-white/10 text-sm">
            ...
            <div className="mt-3 pt-3 border-t border-white/10">
              <a
                href="https://github.com/matthiasnys/dropthemilk"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white text-xs flex items-center gap-2 transition-colors"
              >
      ...
      {/* Watermark */}
      <a
        href="https://glue.blue"
        target="_blank"
        rel="noopener noreferrer"
        className="absolute bottom-4 left-4 z-10 text-white/40 hover:text-white/70 text-xs font-medium transition-colors duration-200"
      >
        glue.blue
      </a>
    </div>
